...
template PointSet internal::ReadBytes<float>(const std::string &path);
template PointSet internal::ReadBytes<uint8_t>(const std::string &path);
template PointSet internal::ReadBytes<int8_t>(const std::string &path);
